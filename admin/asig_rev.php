            ...
            <div class="card card-primary card-outline card-tabs">
                <div class="card-header p-0 pt-1 border-bottom-0">
                    <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="custom-tabs-three-profil-tab" data-toggle="pill" href="#custom-tabs-three-profil" role="tab" aria-controls="custom-tabs-three-profil" aria-selected="false">
                                Modificar datos Revisor
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-content" id="custom-tabs-three-tabContent">
                    <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                        ...
                        <div class="card card-info">
                            <div class="card-header bg-navy color-palette">
                                <h3 class="card-title">Asignacion del Revisor 1</h3>
                            </div>
                            <!-- /.card-header -->
                            <div style="width: 80%" class="card-body">
                                <form action="asig_rev.php" method="post">
                            ...
                            <form method="post" action="../procesos/asig_rev.php">
                            ...
                            <div style="width: 80%" class="card-body">
                                <form  method="post" action="asig_rev.php">
                                    <div class="input-group input-group-sm" style="margin-top:30px; margin-left:0px;">
                                        ...
                                        <tbody>
                                            <?php 
                                                if(isset($_POST['search2'])){
                                                    ...
                                                    $bdocente =  ejecutarSQL::consultar("select * from docente where especialidad_1 LIKE '$searchq2'");
                            ...
                            <form method="post" action="../procesos/asigRevisor1.php">
                                <!-- /.card-body -->
                            <div style="width: 90%" class="card-body">
                                <div class="form-group row">
                                    <div class="form-group row col-6">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="est-cod1" type="Name" class="form-control"  placeholder="Codigo del estudiante">
                                        </div>
                                    </div>
                                    <div class="form-group row col-6">
                                        <label for="inputnameAd" class="col-sm-4 col-form-label">Codigo Doc.</label>
                                        <div class="col-sm-8">
                                            <input name="doc-cod1" type="Name" class="form-control"  placeholder="Codigo del docente">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="custom-tabs-three-profile" role="tabpanel" aria-labelledby="custom-tabs-three-profile-tab">
                        ...
                        <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                            ...
                            <div class="card card-info">
                            <div class="card-header bg-navy color-palette">
                                <h3 class="card-title">Asignacion del Revisor 2</h3>
                            </div>
                            <!-- /.card-header -->
                            <div style="width: 80%" class="card-body">
                                <form action="asig_rev.php" method="post">
                        ...
                        <form method="post" action="../procesos/asigRevisor2.php">    
                                <!-- /.card-body -->
                            <div style="width: 90%" class="card-body">
                                <div class="form-group row">
                                    <div class="form-group row col-6">
                                        <label for="inputnameAd" class="col-sm-4 col-form-label">Codigo Est.</label>
                                        <div class="col-sm-8">
                                            <input name="est_cod2" type="Name" class="form-control"  placeholder="Codigo del estudiante" value = "">
                                        </div>
                                    </div>
                                    <div class="form-group row col-6">
                                        <label for="inputnameAd" class="col-sm-4 col-form-label">Codigo Doc.</label>
                                        <div class="col-sm-8">
                                            <input name="doc_cod2" type="Name" class="form-control"  placeholder="Codigo del docente" value = "">
                                        </div>
                                    </div></div>
                        ...
                        <div class="tab-pane fade show active" id="custom-tabs-three-home" role="tabpanel" aria-labelledby="custom-tabs-three-home-tab">
                            ...
                            <div class="card-body">
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                <th style="width: 10px">ID_Est</th>
                                                <th>Nombre Estudiante</th>
                                                <th style="width: 10px">ID_Doc</th>
                                                <th>Nombre Revisor 1</th>
                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php 
                                        $estudiantes =  ejecutarSQL::consultar("Select est.ID_estudiante, est.nombres as nombre_est, est.revisor_1, doc.ID_docente, doc.nombres as nombre_doc FROM estudiante est LEFT JOIN docente doc on est.revisor_1 = doc.ID_docente");
                                        $upr=1;
                                            ...
                                            <div>
                                                <form method="post" action="../procesos/updEstudiante.php" '.$upr.'">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" name="est-nombre" required="" value="'.$est['nombre_est'].'">
                                                        </td>
                                                        <td>
                                                            <input style="width: 50px" type="text" name="tutor" required="" value="'.$est['revisor_1'].'">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="doc-nombre" required="" value="'.$est['nombre_doc'].'">
                                                        </td>
                                    ...
                                    <table class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nombre Estudiante</th>
                                                <th style="width: 10px">ID_Doc</th>
                                                <th>Nombre Revisor 2</th>
                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                        <?php 
                                        $estudiantes =  ejecutarSQL::consultar("Select est.ID_estudiante, est.nombres as nombre_est, est.revisor_2, doc.ID_docente, doc.nombres as nombre_doc FROM estudiante est LEFT JOIN docente doc on est.revisor_2 = doc.ID_docente");
                                        $upr=1;
                                        while($est=mysqli_fetch_array($estudiantes)){
                                            echo'
                                            <div>
                                                <form method="post" action="../procesos/updEstudiante.php" '.$upr.'">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input style="width: 50px" type="text" name="tutor" required="" value="'.$est['revisor_2'].'">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="doc-nombre" required="" value="'.$est['nombre_doc'].'">
                                                        </td>
